export default function Footer({ isAudioEnabled, isBgMusicEnabled, showHint, setAudio, setMusic }) {
    return (
        <div className="footer-container">
            ...
            <button className="footer-button animated-button" onClick={showHint}>
